...
# Syntax Of Python_Lists (Array) 👇 !
numbers = [1, 2, 3, 4, 5]

#--------------------------------------------------------------------------------------------------

# To Access Values from Python_lists (Array) 👇 !
...
# To Acess all the Values from Python_Lists (Array) 👇 !

print("\nThe values of Python_Lists are => ", numbers) # Prints all the Value..!

#---------------------------------------------------------------------------------------------------

# To update the Values in Python_Lists 👇 !
...
# In Python_Lists different Data_types can be stored in the list ( " Heterogenous - mixture ") 👇 !
